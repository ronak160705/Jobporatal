      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            ...
            <h5><td><?php echo $country;?>,<td><?php echo $state;?></td>,<td><?php echo $city;?></td></td></h5>
            <p><td><?php echo $des;?></td></p>
            <form action="applyjob.php" method="post" enctype="multipart/form-data" style="border: 2px solid gray; padding:10px;" >
           
                <input type="hidden" name="jobseeker" id="jobseeker" value="<?php echo $_SESSION['email']; ?>" >
                <input type="hidden" name="jid" id="jid" value="<?php echo $jid; ?>" >
              <div class="col-sm-12" style="text-align:center;">
                <h2>Send Your Bio-Data for Apply job</h2>
              </div><hr>  
              <div class="row">
                <div class="col-sm-6">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="email" disabled="true" class="form-control" value="<?php echo $_SESSION['email']; ?>">
                  </div>
                </div>
              </div>
              ...
              <ul class="comment-list">
                <li class="comment">
                  ...
                  <div class="comment-body">
                    <h3>Jinal Gola</h3>
                    <div class="meta">October 03, 2023 at 2:00pm</div>
